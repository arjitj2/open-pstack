...
| `plugins/pstack/skills/` (0.15.5 changes through `12d587df`: operator-neutral wording, budget ask, Opus/Grok default panel, round-based verification, instruction trims, rule-conflict fixes), `README-UPSTREAM.md` | [cursor/plugins/pstack @ 12d587df](https://github.com/cursor/plugins/tree/12d587dfb20741cafc376c42c696c5f6e2a64487/pstack) | (c) 2026 Lauren Tan | MIT | [LICENSE](LICENSE) |
