...
|---|---|---|---|
| Claude matrix family | native Agent `pstack-<stem>-<effort>` from its matrix row | Claude CLI | native one-turn probe or one-turn runner probe without a separate auth-status command |
