...
Version 1.7.1 is a draft removal of Claude authentication-status probes. Installed-parent validation is pending; see `maintenance/claude-auth-repro/README.md`.
